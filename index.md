...
- **[May. 2025]** Our [paper](https://arxiv.org/abs/2506.06940) on how the datasets, network architectures, and optimizers influence progressive sharpening is accepted to **ICML 2025**.
- **[Jan. 2025]** Our [paper](https://arxiv.org/abs/2405.16002) on identifying the spurious alignment of SGD in an ill-conditioned valley (a.k.a. river-valley) loss landscape is accepted to **ICLR 2025**.
- **[Jan. 2025]** I joined [Simon Shaolei Du](https://simonshaoleidu.com/)'s group as a visiting student researcher at the [University of Washington](https://www.washington.edu/).
...
- **[Sep. 2023]** Our [paper](https://arxiv.org/abs/2307.04204) on understanding the Edge of Stability in deep learning is accepted to **NeurIPS 2023**.
