...
<small style="display:block; margin-top: 5px; margin-bottom: 0px; font-size: 15px; color: #6f665c;">(* denotes equal contribution)</small>
...
<div class="pub-row">
  <div class="col-sm-12" style="position: relative;padding-right: 15px;padding-left: 20px;">
      <div class="title">{% if link.arxiv %}<a href="{{ link.arxiv }}">{{ link.title }}</a>{% else %}{{ link.title }}{% endif %}</div>
